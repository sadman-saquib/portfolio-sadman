...
const Hero = () => {
  return (
    ...
    className='flex flex-col items-center gap-[35px]'>
      ...
      <h1 className='text-5xl h-8 font-semibold md:hidden'>I'm <span>Sadman</span></h1>
      <p className=' px-12 md:text-xl h-12 text-center md:h-12  text-white/60'>A Programmer, Graphic Designer & Video Editor</p>
